    ...
    <>
      ...
      <div className={`${styles.container} ${isFullscreen ? styles.fullscreen : ''}`}>
        ...
        <div className={isFullscreen ? styles.fullscreen : styles.pdfContainer}>
          ...
          {pdfUrl && isMobile && (
            <div className={styles.mobilePdfView}>
              <p>Mobil cihazda PDF-i görmək üçün yüklə düyməsini istifadə edin:</p>
              <button 
                onClick={downloadPdf} 
                className={styles.button}
              >
              ...
              <p>Yaxud aşağıdakı linkə toxunun:</p>
              <a href={pdfUrl} target="_blank" rel="noopener noreferrer" className={styles.mobileLink}>
                Quran PDF-i brauzerdə aç
              </a>
            </div>
          )}
        </div>
